...
const About: React.FC<AboutProps> = () => {
  ...
  <div>
    <h3 className={styles.zeta}>ABOUT ME<br></br><br></br>I'm currently learning: SQL - NodeSql - Csharp - Unity - React - Java<br></br>I’m looking to collaborate on Making a Gameproject<br></br>
